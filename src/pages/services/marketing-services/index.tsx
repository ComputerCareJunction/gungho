      ...
      <div className="min-h-screen bg-white">
        <div className="page-content-inset py-12 pb-20">
          <header className="text-center mb-14 sm:mb-16">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-slate-900 mb-5 leading-tight">
          ...
          <div className="space-y-10">
            ...
            <section className="rounded-2xl border border-slate-200 bg-slate-50 p-6 sm:p-8">
              ...
              <ul className="space-y-3 pl-0 sm:pl-14 list-disc list-inside marker:text-primary text-slate-600">
            ...
            <section className="rounded-2xl border border-primary/20 bg-orange-50/60 p-6 sm:p-8">
              <div className="flex items-start gap-4 mb-5">
              ...
              <ul className="grid sm:grid-cols-2 gap-3 pl-0 sm:pl-14">
                {sections.integratedMarketing.items.map((line) => (
                  <li
                    key={line}
                    className="flex items-center gap-2 rounded-lg bg-slate-50 px-4 py-2.5 text-slate-800 text-sm sm:text-base border border-slate-200 shadow-sm transition-colors hover:bg-slate-100"
                  >
